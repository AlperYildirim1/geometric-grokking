...
> **Note:** This errata applies to [arXiv v1 (2603.05228)](https://arxiv.org/abs/2603.05228). A corrected v2 will be uploaded shortly.
...
The v1 row labeled "Fully Bounded (λ = 0.0)" contained results from a different experimental run. All spherical results have been rerun from scratch with verified weight decay settings. The corrected Table 1:
...
- At LR=1×10⁻⁴, weight decay has minimal effect — both λ values converge in ~2,400–2,480 epochs.
- At LR=6×10⁻⁴, removing weight decay helps: λ=0.0 converges faster (820 vs 1,560) with much lower variance (std 199 vs 853).
